 ...
 * @author yusuf
 */
public class menuUsage extends javax.swing.JFrame {

    /**
     * Creates new form menuUsage
     */
    public menuUsage() {
        initComponents();
    }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if (i == JFileChooser.APPROVE_OPTION) {
            ...
            try(Scanner scanner = new Scanner(new BufferedReader(new FileReader(file)))){
                ...
                Logger.getLogger(menuUsage.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuUsage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
